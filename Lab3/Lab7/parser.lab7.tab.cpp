...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 74 "parser.lab7.ypp"
    { std::cout << (yyvsp[(1) - (1)].Name) << std::endl; ;}
    break;

  case 3:
#line 75 "parser.lab7.ypp"
    { std::cout << (yyvsp[(1) - (1)].Value) << std::endl; ;}
    break;


/* Line 1267 of yacc.c.  */
#line 1376 "parser.lab7.tab.cpp"
      default: break;
    }
